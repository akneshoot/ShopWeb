...
quadrantChart
    ...
    "Чат поддержки": [0.90, 0.30]
    "Обратная связь": [0.80, 0.50]
    "Просмотр истории покупок": [0.70, 0.55]
    "Генерация отчетов": [0.20, 0.90]
    "Аналитика заказов": [0.10, 0.85]
    "Интеграция с платежной системой": [0.05, 0.95]
    "Добавление в корзину": [0.35, 0.20]
    "Авторизация": [0.50, 0.15]
    "Сортировка товаров": [0.60, 0.35]
    "Рекомендованные книги": [0.25, 0.10]
    "Сохранение книг в избранное": [0.40, 0.05]
    "Рассылка email-уведомлений": [0.15, 0.40]
