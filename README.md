...
quadrantChart
    ...
    "Чат поддержки": [0.85, 0.25]
    "Обратная связь": [0.75, 0.35]
    "Просмотр истории покупок": [0.60, 0.45]
    "Генерация отчетов": [0.15, 0.85]
    "Аналитика заказов": [0.20, 0.80]
    "Интеграция с платежной системой": [0.10, 0.90]
    "Добавление в корзину": [0.25, 0.75]
    "Авторизация": [0.30, 0.65]
    "Сортировка товаров": [0.40, 0.70]
    "Рекомендованные книги": [0.85, 0.15]
    "Сохранение книг в избранное": [0.90, 0.25]
    "Рассылка email-уведомлений": [0.80, 0.10]
